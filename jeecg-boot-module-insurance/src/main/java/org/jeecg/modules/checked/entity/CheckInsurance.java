package org.jeecg.modules.checked.entity;
...
public class CheckInsurance implements Serializable {
    ...
    @Dict(dictTable="distribution_channel",dicCode = "channel_type",dicText = "channel_name")
...
//    private String channelName;
	...
	/**使用性质*/
	@Excel(name = "使用性质", width = 15,dictTable="insurance_usage",dicCode = "usage_type",dicText = "usage_name")
    @ApiModelProperty(value = "使用性质")
    @Dict(dictTable="insurance_usage",dicCode = "usage_type",dicText = "usage_name")
