...
import org.jeecg.common.aspect.annotation.Area;
...
//        JSONArray arr = JSONObject.parseArray(json);
        ...
        for (Field field : oConvertUtils.getAllFields(record)) {
            //update-end--Author:scott  -- Date:20190603 ----for：解决继承实体字段无法翻译问题------9
            ...
            if (field.getAnnotation(Area.class) != null) {
                String areaCode = String.valueOf(item.get(field.getName()));

                //翻译字典值对应的txt
                String textValue = provinceCityArea.getText(areaCode, "，");
                item.put(field.getName() + CommonConstant.AREA_TEXT_SUFFIX, textValue);
            }
